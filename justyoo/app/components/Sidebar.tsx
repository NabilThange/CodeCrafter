...
const navItems = [
  ...
  {
    href: process.env.NEXT_PUBLIC_VANE_URL || "http://localhost:3000",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    href: process.env.NEXT_PUBLIC_WORLDMONITOR_URL || "http://localhost:5173",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
